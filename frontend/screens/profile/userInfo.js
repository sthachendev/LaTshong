          ...
          >
            ...
            >
              <TouchableOpacity
                onPress={() => {
                  userInfo[0].imageurl &&
                    setImageUri(`${config.API_URL}/${userInfo[0].imageurl}`);
                  handleImageClick();
                }}
                activeOpacity={1}
              >
                ...
                {image ? (
                  ...
                  <>
                    {userInfo[0].imageurl.length > 0 ? (
                      <Image
                        source={{
                          uri: `${config.API_URL}/${userInfo[0].imageurl}`,
                        }}
                        style={{
                          width: 120,
                          height: 120,
                ...
                {userid === current_userid && (
                  ...
                  >
                    <MaterialIcons name="create" color="#1E319D" size={20} />
                  </TouchableHighlight>
                )}
              </TouchableOpacity>
            </View>
            ...
            <View style={{ flexDirection: "column" }}>
              <View style={{ flexDirection: "row", justifyContent: "center" }}>
                ...
                >
                  {capitalizeWords(userInfo[0].name)}
                </Text>
              ...
              >
                Joined ~ {getTimeDifference2(userInfo[0].created_on)}
              </Text>
            </View>
                  ...
                  <TouchableHighlight
                    ...
                    onPress={() => {
                      navigation.navigate("ChatRoom", {
                        touserid: userInfo[0].id,
                        imageurl: userInfo[0].imageurl,
                        title: capitalizeWords(userInfo[0].name),
                      });
                    }}
                  >
            ...
            {userid === current_userid && (
              <TouchableHighlight
                ...
                onPress={() => {
                  ...
                  userInfo[0].bio && setDesc(userInfo[0].bio);
                }}
                underlayColor="#F1F2F6"
              >
                <MaterialIcons
