    ...
    if (post.posttype === "feed_post") {
      try {
        const res = await axios.delete(
          `${config.API_URL}/api/post-feeds/${postid}`,
          {
            headers: {
      ...
      try {
        const id = postid;
        const res = await axios.delete(
          `${config.API_URL}/api/post-jobs/${id}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
              ...
              >
                ...
                <View style={styles.buttonContainer2}>
                  ...
                  <Text style={styles.buttonText2}>
                    {" "}
                    {post.posttype == "job_post" && "Job Post"}
                    {post.posttype == "feed_post" &&
                  ...
                  {post.posttype === "feed_post" && data && (
                    <>
                      <View style={{ backgroundColor: "#fff" }}>
                        <ImageViewer
                          uri={`${config.API_URL}/${data[0].media_uri}`}
                        ...
                        <View style={{ paddingVertical: 10 }}>
                          ...
                          >
                            {data[0].imageurl.length > 0 ? (
                              <Image
                                source={{
                                  uri: `${config.API_URL}/${data[0].imageurl}`,
                                }}
                                style={{
                                  width: 40,
                                  height: 40,
                            ...
                            <View style={{ flex: 1 }}>
                              ...
                              >
                                {getTimeDifference2(data[0].postdate)}
                              </Text>
                            </View>
                          </View>
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                ...
                                {data[0]?.status == "o" &&
                                  getTimeDifference(data[0]?.postdate)}
